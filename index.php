 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#watch"> <img src="public/images/watch.jpg" class="img-fluid " alt="" style="border-radius:0.5rem">
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="public/images/clothing.jpg" class="img-fluid zoom" alt="" style="border-radius:0.5rem" >
                     <div class="h5 pt-3 font-weight-bolder">
                        Clothing
                     </div>
                  </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#shoes">
                 <img src="public/images/shoes.jpg" class="img-fluid   " alt="" style="border-radius:0.5rem">
                <div class="h5 pt-3 font-weight-bolder">
                    Shoes
                 </div>
             </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#headphones">
                 <img src="public/images/headphones.jpg" class="img-fluid  " alt="" style="border-radius:0.5rem">
                 <div class="h5 pt-3 font-weight-bolder">
                    Headphones
                 </div>
              </div>
